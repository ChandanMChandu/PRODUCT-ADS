...
the list.*/
	...
	Student std0 ={1,"Naren",22,"CODING"};
	Student std1 ={2,"chandan",23,"testing"};
	Student std2 ={3,"anupam",24,"CODING"};
	Student std3 ={4,"pinaka",25,"CODING"};
	Student std4 ={5,"shubham",26,"CODING"};

	slist_add_student(list,1,"Naren",22,"CODING");
	slist_add_student(list,2,"abc",22,"CODING");
	slist_add_student(list,3,"byy",22,"CODING");
